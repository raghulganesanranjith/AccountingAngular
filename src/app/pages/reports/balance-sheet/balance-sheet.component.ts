...
export class BalanceSheetComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.filterFields = this.balanceSheetService.getBalanceSheetFilters();
    this.loadReport();
  }
  ...
  loadReport(): void {
    this.isLoading = true;
    this.balanceSheetService.getBalanceSheetReport(this.filters).subscribe(
      (data: any) => {
        this.report = data;
  ...
  exportToCSV(): void {
    ...
    link.setAttribute('download', 'balance-sheet-report.csv');
